...
const messageTemplates = [
  { id: "1", title: "Thank You", content: "Thank you for reaching out! We appreciate your interest in our services." },
  { id: "2", title: "Appointment Confirmation", content: "Your appointment has been confirmed for {date} at {time}." },
  { id: "3", title: "Support Response", content: "We're sorry to hear about the issue. Our team will help resolve this quickly." }
];
                      ...
                      >
                        ...
                        {msg.tags.length > 0 && (
                          <div className="flex flex-wrap gap-1 mt-2">
                            {msg.tags.slice(0, 2).map((tag, idx) => (
          ...
          <Card className="shadow-sm h-full flex flex-col">
              ...
              {selectedMessage.tags.length > 0 && (
                <div className="flex flex-wrap gap-1 mt-2">
                  {selectedMessage.tags.map((tag, idx) => (
                    <Badge key={idx} variant="outline" className="hover:bg-muted cursor-pointer group">
                      {tag}
                      <span 
            ...
            <div className="flex flex-col h-full">
                  ...
                  <div className="mb-2 max-h-[150px] overflow-y-auto">
                    {selectedMessage.notes.length > 0 ? (
                      selectedMessage.notes.map((note, index) => (
                        <div key={index} className="bg-background p-2 rounded-md mb-2 text-xs">
                          {note}
                        </div>
                      ))
                    ) : (
              ...
              {attachments.length > 0 && (
                <div className="border-t p-3 bg-secondary/5">
